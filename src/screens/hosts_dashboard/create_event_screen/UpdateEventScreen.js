...
const UpdateEventScreen = ({route, navigation}) => {
  ...
  const update_event = async () => {
    ...
    if (SelectedImage && Object.keys(SelectedImage).length > 0) {
      ...
      formdate.append('cover_image', event_banner);
    }
    try {
      setLoader(true);
      const response = await axios.put(
        `${process.env.API_ROOT_URI}/api/event/update/${event_id}`,
        formdate,
        {
          headers: {
      ...
      if (response.status === 200) {
        setLoader(false);
        reset();
        ToastAndroid.show('Event Update Success', ToastAndroid.SHORT);
      }
    } catch (error) {
      setLoader(false);
      console.log(error);
  ...
  //////////////////////////////
  const fetch_single_event = async () => {
    try {
      setLoader(true);
      ...
      if (response.status == 200) {
        ...
        setEventVisibility(data.visibility);
        setEventReqeustJoin(data.allow_request_to_join);
        setEventAgeRestriction(data.age_restriction);
        setEventVarifiction(data.guest_verification_required);
        setEventTicket(data.ticket0_type);
        setEventStartDate(data.start_datetime);
        setEventEndDate(data.end_datetime);
        setEventLocation(data.location);
        setEventMaxGuests(data.max_guests);
        setEventStatus(data.status);
        setEventBanner(data.cover_image);
        setLoader(false);
        // ToastAndroid.show('Event Update Successfully', ToastAndroid.SHORT);
      }
    } catch (error) {
      setLoader(false);
      console.logg(error);
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <ImagePickerComponent
        ...
        {SelectedImage || event_banner ? (
          <Image
            source={{
              uri: event_banner
                ? `${process.env.API_ROOT_URI}/public/event_img/${event_banner}`
                : SelectedImage.uri,
            }}
      ...
      <View style={styles.inputGroup}>
        ...
        <View
          ...
          <Picker
            ...
            <Picker.Item label="welcome" value="welcome" />
            <Picker.Item label="welcome" value="welcome" />
            <Picker.Item label="welcome" value="welcome" />
            <Picker.Item label="welcome" value="welcome" />
            <Picker.Item label="welcome" value="welcome" />
      ...
      <View style={styles.inputGroup}>
        ...
        <View
          ...
          <Picker
            selectedValue={event_age_restriction}
      ...
      <View style={styles.inputGroup}>
        ...
        <View
          ...
          <Picker
            selectedValue={event_varification}
            onValueChange={(value, index) => setEventVarifiction(value)}>
      ...
      <View style={styles.inputGroup}>
        ...
        <View
          ...
          <Picker
            selectedValue={event_visibility}
            onValueChange={(value, index) => setEventVisibility(value)}>
      ...
      <View style={styles.inputGroup}>
        ...
        <View
          ...
          <Picker
            selectedValue={event_ticket}
            onValueChange={(value, index) => setEventTicket(value)}>
      ...
      <View style={styles.inputGroup}>
        ...
        <View
          ...
          <Picker
            selectedValue={event_status}
            onValueChange={(value, index) => setEventStatus(value)}>
